...
const index = () => {
	...
	if (!products || !cartInfo || isProductsLoading || isCartInfoLoading)
		return <CartSkeleton />

	if (cartInfoError || productsError || isLoadingError || loadingError)
		return <Error />
	return (
		<Flex
			as='div'
			...
			<Head>
				...
				<meta
					name='description'
					content='جزئیات سبد خرید شما - محصولات درون سبد و قیمت'
				/>
			...
			<Flex
				...
				<Flex
					...
					<Flex
						...
						flexDir='column'
						p='1rem'
						display={products?.pages[0].results.length === 0 ? "none" : "flex"}>
